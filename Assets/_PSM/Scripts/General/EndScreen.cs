...
public class EndScreen : MonoBehaviour
{
    ...
    public void Initialize(string titleText, string subtitleText, string suspectedPerson, Sprite picture, bool suspectedPersonFound, bool documentsRead, bool emailsRead, bool trashBinSearched, float timeSpend)
    {
